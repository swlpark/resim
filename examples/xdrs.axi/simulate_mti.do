...
vlog -work xil_defaultlib -incr "./xdrs/cdn_axi_bfm_0.v" 
#vlog -work xil_defaultlib -incr "./xdrs/cdn_axi4_example_test.v" 
vlog -work xil_defaultlib "./xdrs/glbl.v"

# load simulation
vsim -t ps -voptargs="+acc" -pli "C:/Xilinx/Vivado/2016.2/lib/win64.o/libxil_vsim.dll" -L unisims_ver -L unimacro_ver -L secureip -L xil_defaultlib xil_defaultlib.glbl -permit_unmatched_virtual_intf -L mtiReSim xdrs
